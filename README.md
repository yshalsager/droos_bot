...
- يمكن للمشرفين تشغيل الأموار الخاصة بهم مثل `/stats` باستخدام القائمة بجانب خانة الكتابة (تظهر للمشرفين فقط)
...
- تجب إضافة البوت إلى قناة التيليجرام حتى يتمكن من الوصول إلى الرسائل فيها
- إذا كانت قناة التيليجرام خاصة يجب تعديل روابط الرسائل وإضافة `-100` أول ال Id الخاص بالقناة. مثلا يتم تحويل الرابط من `https://t.me/c/37587323011/16` إلى `https://t.me/c/-1003758732311/16` 
